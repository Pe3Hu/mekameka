...
func init_arr() -> void:
	arr.windrose = ["east", "south", "west", "north"]
...
func init_orientation() -> void:
	dict.orientation = {}
	dict.orientation["north"] = "vertical"
	dict.orientation["east"] = "horizontal"
	dict.orientation["south"] = "vertical"
	dict.orientation["west"] = "horizontal"
	
	dict.mirror = {}
	dict.mirror["north"] = "south"
	dict.mirror["east"] = "west"
	dict.mirror["south"] = "north"
	dict.mirror["west"] = "east"
